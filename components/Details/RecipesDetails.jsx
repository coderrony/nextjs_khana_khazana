...
function RecipesDetails({ recipe }) {
  // Convert the recipe object to a plain object
  const plainRecipe = {
    id: recipe?.id,
    image: recipe?.image,
    name: recipe?.name,
        ...
        <div className="col-span-12 md:col-span-6 py-8 flex flex-col justify-center">
          ...
          <div className="flex gap-4 justify-center divide-x my-12">
            <div className="flex-1 text-center">
              ...
              <p className="text-gray-500 text-sm">{plainRecipe.activeTime}</p>
            </div>
            <div className="flex-1 text-center">
              <svg
                xmlns="http://www.w3.org/2000/svg"
              ...
              <p className="text-gray-500 text-sm">{plainRecipe.totalTime}</p>
            </div>
            <div className="flex-1 text-center">
              <svg
                xmlns="http://www.w3.org/2000/svg"
              ...
              <p className="text-gray-500 text-sm">{plainRecipe.serves}</p>
            </div>
          </div>

          <DetailsAction recipeId={plainRecipe.id} />
        </div>
      </div>
    </section>
  );
